<!--START OF MODAL-->
            <div class="modal fade" id="modalEditarSala" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <!-- TITULO -->
                          <h3 id="cabeceraModalSubProcesos"type="hidden" class="modal-title subfuente text-center">Actualización de datos de salas del museo</h3>
                        </div>
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-md-offset-2 col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-block btn-success" onClick="ajaxEditarSala('<?php echo base_url(); ?>');">Aceptar</button> 
                                    </div>
                                </div>
                            </div>
