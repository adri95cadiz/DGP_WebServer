                    ...
                    <div class="row">
                        <form class="form-horizontal" role="form">
                            <div class="form-group row">
                                <label for="txtIdZona" class="col-lg-2 col-md-3 control-label">Codigo Generado:</label>
                            ...
                            <div class="row form-group">
                                    <label class="col-lg-2 col-md-3 control-label" for="cboTipoZona">Tipo de Zona:</label>
                                ...
                                <div class="form-group"> -->
                                    <label class="col-lg-1 col-md-1 control-label" for="cboSala">Sala:</label>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-2 col-lg-offset-8 col-lg-2 col-lg-offset-9 text-right">
                                            ...
                                            foreach ($dispositivos as $row) { 
                                                echo '<tr>';
                                                    ...
                                                    echo '<td width="7%" class="center text-center" width="10%">';?>
                                                        <button type="button" class="btn btn-warning btn-circle" onClick="traerDatosDispositivo('<?php echo $row['ZONid']."', '".$row['ZONdescription']."', '".$row['ROOid']."', '".$row['ELEid']."', '".$row['ZONstate'];?>')"><i class="fa fa-pencil"></i></button></td>
                                                    <?php
                                                    echo '<td width="7%" class="center text-center" width="10%">';?>
